...
| `D-26` | `attackPortal` rejects same-side attacks and attacks on an already-destroyed or captured portal, matching the guard `captureStep` already had; direct test coverage for the attack path (none existed) |
