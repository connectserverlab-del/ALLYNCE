...
```bash
npm install
npm test                 # 581 tests: combat math, cohesion, composition, succession, clones,
                         # rituals, portals, cards, ranks, the holding, wanted board, marching,
                         # map generation, terrain, weather, scenarios, campaign, save/load,
                         # replay, roster, AI, and a full scenario end to end
npm run typecheck
