 ...
 *   1c. `scripts/bundle-cards.mjs` compiles the deck rules for the browser the same way, so the Deck
 ...
 *   3. Substitute all three into `web/sample/template.html` and write `docs/samples/ashfall-hold.html`.
 *
